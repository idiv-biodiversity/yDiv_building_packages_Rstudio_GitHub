...
* build a function that repeats the linear model you built in your paper.

Or, in short, *reproduce the analysis you carried out in your manuscript*. Lets build, as a first example, a function that reports summary statistics of your dataset. We call this function `report_summary`. 
...
load_all()
#> Loading myPackage
report_summary(iris$Sepal.Length, measure = "median")
#> median 
#>    5.8 
report_summary(iris$Sepal.Length, measure = "mean", quantiles = seq(0, 1, 0.2))
#> mean   0%  20%  40%  60%  80% 100% 
#> 5.84 4.30 5.00 5.60 6.10 6.52 7.90 
```
