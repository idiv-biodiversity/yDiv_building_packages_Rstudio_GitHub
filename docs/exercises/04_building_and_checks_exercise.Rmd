...
On top of `check` we will run two additional test to make sure the code of your package is readable and does not cause problems. First, we will run the spellcheck function of the detools package, to check the documentation of your package. 
