...
[link](https://cran.r-project.org/web/packages/lintr/index.html)


## 1. Getting started

Then you can either click on <br>*File > New Project > New Directory > R package*<br> and provide all sort of information, or simply type in `create_package()` into the console.
